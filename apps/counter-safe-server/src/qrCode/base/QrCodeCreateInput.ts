...
class QrCodeCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RegisterCreateNestedManyWithoutQrCodesInput,
  })
  @ValidateNested()
  @Type(() => RegisterCreateNestedManyWithoutQrCodesInput)
  @IsOptional()
  @Field(() => RegisterCreateNestedManyWithoutQrCodesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ScannedCreateNestedManyWithoutQrCodesInput,
  })
  @ValidateNested()
  @Type(() => ScannedCreateNestedManyWithoutQrCodesInput)
  @IsOptional()
  @Field(() => ScannedCreateNestedManyWithoutQrCodesInput, {
    nullable: true,
  })
